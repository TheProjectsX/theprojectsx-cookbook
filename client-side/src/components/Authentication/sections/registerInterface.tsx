...
const RegisterInterface = ({
    ...
    return (
        <div className="max-w-[500px] w-full bg-white dark:bg-slate-800 p-5 rounded-md cursor-auto dark:border-slate-700 relative transition-colors not-dark:shadow-lg">
            ...
            {/* Google Login */}
            <button className="flex items-center justify-center gap-2 w-full dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 p-2.5 rounded-lg border-2 border-slate-200 dark:border-slate-600 cursor-pointer transition-colors">
            ...
            <div className="pt-5 pl-1">
                <p className="text-sm font-medium">
                    ...
                    <button
                        ...
                        className="text-highlight dark:text-[dodgerBlue] hover:underline underline-offset-4 cursor-pointer"
                    >
                        Login Now!
                    </button>
                </p>
